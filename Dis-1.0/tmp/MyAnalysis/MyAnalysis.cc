...
namespace Rivet {
  ...
  public:
    ...
    void init() {
     ...
     /// ZFinder zf();
      ...
      book(_histMult   , "Mult", 100, -0.5, 120);
      book(_histMultCh , "MultCh", 100, -0.5, 120);

      book(_histPt   , "Pt", 300, 0, 120);
      book(_histPtCh , "PtCh", 300, 0, 120);

      book(_histE   , "E", 100, 0, 120);
      book(_histECh , "ECh", 100, 0, 120);
      ...
      book(_histZ_mass ,"Z_mass", 50, 80.0, 100.0);
      book(_histZ_pT ,"Z_pT", logspace(100, 0, 0.5*(sqrtS()>0.?sqrtS():14000.)/GeV));
      book(_histZ_pT_peak ,"Z_pT_peak", 25, 40, 60);
  ...
  private:
    ...
    Histo1DPtr _h_H_mass, _h_H_pT, _h_H_pT_peak, _h_H_y, _h_H_phi;
